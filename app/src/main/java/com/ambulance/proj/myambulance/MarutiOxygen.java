...
public class MarutiOxygen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_maruti_oxygen);

        profilePic = findViewById(R.id.marutiPic);
        profileName = findViewById(R.id.sumoOxyDiverName);
        profilePhone = findViewById(R.id.marutiDriverPhone);
        profileEmail = findViewById(R.id.sumoOxyDriverEmail);
        profileAmb = findViewById(R.id.marutiDriverAmbNo);
        profileUpdate = findViewById(R.id.sumoOxyconf);
        profilecancel=findViewById(R.id.maruticancel);
       ...
       /*storageReference.child("UserProfile").getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
        ...
        storageReference.child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child("UserProfile/Images/Profile Pic").getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(MarutiOxygen.this, "Failed "+e.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(DatabaseError databaseError) {
                Toast.makeText(MarutiOxygen.this, databaseError.getCode(), Toast.LENGTH_SHORT).show();
            }
        });
