...
public class SumoSignIn extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sumo_sign_in);
        ...
        profilecancel=findViewById(R.id.sumocancel);
       ...
       /*storageReference.child("UserProfile").getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
        ...
        storageReference.child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child("UserProfile/Images/Profile Pic").getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(SumoSignIn.this, "Failed "+e.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(DatabaseError databaseError) {
                Toast.makeText(SumoSignIn.this, databaseError.getCode(), Toast.LENGTH_SHORT).show();
            }
        });
