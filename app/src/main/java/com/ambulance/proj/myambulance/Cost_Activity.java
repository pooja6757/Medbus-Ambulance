...
public class Cost_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Intent intent=new Intent(this,select_hospital.class);

        b1=(ImageButton)findViewById(R.id.marutiomani);
        b2=(ImageButton)findViewById(R.id.marutioxygen);
        b3=(ImageButton)findViewById(R.id.sumo);
        b4=(ImageButton)findViewById(R.id.sumooxygen);
